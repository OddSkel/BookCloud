...
use crate::{
    grpc::contracts::book_recommendation::book_recommendation_grpc_server::BookRecommendationGrpcServer,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    Server::builder()
        .add_service(BookRecommendationGrpcServer::new(
            BookRecommendationService::new(
