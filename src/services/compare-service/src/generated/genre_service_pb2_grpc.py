...
class GenreAnalysisGrpcStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetGenres = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetBookGenres = channel.unary_unary(
                '/gateway.genreservice.GenreAnalysisGrpc/GetBookGenres',
                request_serializer=genre__service__pb2.GetBookGenresRequest.SerializeToString,
                response_deserializer=genre__service__pb2.GetBookGenresResponse.FromString,
                _registered_method=True)
...
class GenreAnalysisGrpcServicer(object):
    ...
    def GetBookGenres(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_GenreAnalysisGrpcServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBookGenres': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBookGenres,
                    request_deserializer=genre__service__pb2.GetBookGenresRequest.FromString,
                    response_serializer=genre__service__pb2.GetBookGenresResponse.SerializeToString,
            ),
...
class GenreAnalysisGrpc(object):
    ...
    def GetBookGenres(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/gateway.genreservice.GenreAnalysisGrpc/GetBookGenres',
            genre__service__pb2.GetBookGenresRequest.SerializeToString,
            genre__service__pb2.GetBookGenresResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
